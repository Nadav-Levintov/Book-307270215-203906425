...
class TestUtils {
  ...
  public static BookScoreReader setupAndGetReader(String fileName) throws Exception {
    String fileContents =
   ...
   return wait(() -> {
      ...
      Injector $ = Guice.createInjector(new BookScoreModule(), new TestingLineStorageModule());
      $.getInstance(BookScoreInitializer.class).setup(fileContents);
      return $.getInstance(BookScoreReader.class);
